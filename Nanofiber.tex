...
\end{align}
You can also rewrite the outer products using Green function tensors. It is clear that the optimal quantization axis to maximum $ A_{J_3}^{-1} $ and $ \kappa/\gamma_s $is determined by the anisotropy of the guided nanofiber modes or their Green function tensors.}
