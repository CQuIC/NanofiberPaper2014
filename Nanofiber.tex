...
&d \expt{\Delta \hat{J}_3^2}  = - \kappa \expt{\Delta \hat{J}_3^2}^2 dt + 2 \gamma_{33} \expt{\Delta \hat{J}_3^2}dt + \frac{1}{4}\left(\gamma_{00}\comment{-}2\gamma_{33} \right) N_A dt + \left(\frac{\gamma_{03}}{2}-\gamma_{30}\right) \expect{\hat{J}_3} dt    
\end{align}
