...
by noting
	\begin{align}
		...
		\!\!\!\!&\!=\! i \frac{ 2\pi \omega\!_0}{v_g} \mathbf{u}^*_\mu (\!\br'\!) \!\cdot\! \poltens \!\cdot\! \mathbf{u}_{\mu'} (\!\br'\!) \! =\! - i \frac{2 \pi}{\hbar} \!\!\!\sum_{e,g,g'}\!\!  \hat{\sigma}\!_{gg'} \frac{g_{\!\mu,e,g}^* g\!_{\mu'\!\!,e,g'}}{ \Delta_{eg} \!\!+\! i \Gamma\!_{e}/2 }, 
	\end{align}
