...
The measurement strength, 
	...
	\end{align}
quantifies the rate at which squeezing occurs. The fluctuations in the integrated polarimetry signal are found using \erf{Eq::XPcommutator}, 
	\begin{align}
		\Delta \mathcal{M}^2 &= N_L /4 + ( \chibir N_L /2 )^2 \delta N_A^2\label{Eq::MeasurementVariance}\\
			&\equiv \shotnoise + \projnoise.
	\end{align}
