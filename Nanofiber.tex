...
(a) Metrological spin squeezing parameter $\xi^{2}${\color{blue}, Eq. (?)}. 
...
(c) OD/atom=$\sigma_0 A_{in}/A^2_{J_3}$, Eq. (?) .
(d) Rates of atom loss, $\gamma_{00}$, and depolarization, $\gamma_{11}$ relative to the characteristic scattering rate $\gamma_s$.  Eqns. (?)} }\label{Fig::Squeezing_QuantizationAxis}
\end{figure}
%================
