...
\begin{equation}
\chi \frac{N_{\rm min}}{2} \langle \hat{S}_2^{\rm in}\rangle =  \langle \Delta \hat{S}_3^{\rm in}\rangle,
\end{equation}
...
\begin{equation}
N_{\rm min} = \frac{2}{\chi}\sqrt{\frac{2}{N_L}} = \frac{v_g}{c}\sqrt {\frac{A_{\rm in}}{\sigma}} \frac{  2 \sqrt{2}}{1-r},
\end{equation}
