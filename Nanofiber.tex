...
We studied the strong \comment{cooperativity} in the atom-light interface that can be achieved based on an optical nanofiber platform in the dispersive regime.  
...
In contrast, for atoms in free space, the atom-light coupling is typically orders of magnitude smaller, $ \mathrm{OD}/\mathrm{atom} \sim 10^{-6}$.  
Thousands of atoms add linearly to achieve a large total co\"{o}perativity.
