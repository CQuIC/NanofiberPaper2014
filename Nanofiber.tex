...
We explore QND measurement of cesium atoms in the hyperfine manifold of the of the electronic ground state, $6S_{1/2}$ via polarization spectroscopy.  


 prepared in the ``clock states", $\ket{\up} = \ket{6S_{1/2}, F=4, M_F=0}$ 
