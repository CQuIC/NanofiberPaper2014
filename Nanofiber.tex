...
(b) Magnitude of the magic detunings, $|\Delta^{m_f}|/2\pi$, and (c) dimensionless rotation angle  $\chi_{\tiny J_3}$ for an atom trapped on the $x$-axis at $ r'\!_\perp=1.8a $ as the quantization axis, \erf{Eq::QuantizationAxis}, is varied in the $x$-$y$ plane. 
...
\begin{align}
&\expt{\hat{N}_A} = \sum_n \expt{\hat{\mathbbm{1}}^{(n)}_C} \\
