...
\textcolor{blue}{Mainly focus on the semi-classical radiation problem of a two-level dipole in the evanescent field of a nanofiber. Make expressions as general as possible for the natural extension to the real atom and quantized field case which will be discussed next.} 
