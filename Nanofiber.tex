...
Similarly, the ratio between $ \kappa $ and $ \gamma_s $ characterize the coupling strength between the atom ensembles and the light, which is independent of light intensity. Together with those rates discussed above, the spin squeezing dynamics can be fully described independent of light intensity.}
