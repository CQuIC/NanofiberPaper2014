...
\begin{align}
\mathbin{\color{red}{\delta\phi}} &= -\frac{\Gamma^{g}_{11}}{\Delta} = - \frac{\sigma_0 
...
\end{align}
Therefore, Equ.~\ref{eq:deltaphiGamma1D} is valid for a generalized atomic polarizability. 
...
g_\mu^*(\omega)g_{\mu'}(\omega)}{\Delta+i\Gamma_{fiber}/2}\\
&= \delta_{mm'}\delta_{ff'}-i\frac{ \frac{2\pi 
\omega}{v_g}\mathbf{u}^*_{mf}(\br'_\perp)\cdot\mathbf{d}_{ge} 
\mathbf{d}_{eg}\cdot\mathbf{u}_{m'f'}(\br'_\perp)e^{i(f'-f)\beta_0 z'}}{\Delta+i\Gamma_{fiber}/2}\\
&=  \delta_{mm'}\delta_{ff'}-i\frac{ \frac{2\pi 
\omega}{v_g}\mathbf{u}^*_{mf}(r'_\perp)\cdot\mathbf{d}_{ge} 
\mathbf{d}_{eg}\cdot\mathbf{u}_{m'f'}(r'_\perp)e^{i(m'-m)\phi'}}{\Delta+i\Gamma_{fiber}/2}.
\end{align}
...
\omega}{v_g}\mathbf{u}^*_{mf}(r'_\perp)\cdot\mathbf{d}_{ge} 
\mathbf{d}_{eg}\cdot\mathbf{u}_{m'f'}(r'_\perp)}{\Delta+i\Gamma_{fiber}/2}\\
