...
The squeezing of $\varz$ is determined by the measurement strength, $\kappa/\gamma_s$, (shown in \frf{fig:OD_q_xyplane_r1d8a_m44}) followed from \erf{Eq::chieff}. 
...
Shown in \frf{fig:gamma34_q_D1_xyplane_NA2500_r1d8a_m44} is one important spin flip rate due to optical pumping from $ \ket{\uparrow} $ to $ \ket{\downarrow} $ which kicks the optimal quantization axis off the \emph{y}-axis for a smaller value or weaker decoherence.
