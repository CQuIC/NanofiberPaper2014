...
\appendix
\section{Radiation fields from an atom close to a nanofiber}
...
\boldsymbol{\mathcal{B}}= \mu\boldsymbol{\mathcal{H}}\approx \boldsymbol{\mathcal{H}} $. 

Now that the longitudinal components of the electrical and magnetic fields can be expanded as
...
The integral in Equs.~\ref{EHzgauss} should be chosen as path $C_1$ as shown in Fig.~\ref{fig:integralpath} to detour the branch cuts and singularities of integrands. 
